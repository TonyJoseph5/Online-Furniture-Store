...
if(isset($_POST['submit']))
{
	...
	$result=mysqli_query($conn, "SELECT * FROM tbl_login WHERE username = '$user'") or die(mysqli_error($conn));
    ...
    {  
         ...
         {  
			...
			if(password_verify($psw, $row['password']))
			{
				...
				{
					echo "<script type='text/javascript'>window.location.href='cp/addCategory.php';</script>";
				}	
			}
			else
			{
						...
						<div class="card-body">
							...
							<form method="POST" class="my-login-validation" novalidate="">
								...
								<div class="form-group">
									...
									<span><?php if(isset($message)){echo "<font color='red'>$message</font>";}?></span>
								    <div class="invalid-feedback">
